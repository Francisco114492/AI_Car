...
def get_behaviour_data(results_path, filename='best_behaviour.txt'):
    ...
    '''
    try:
        with open(f'./Neural_Network/{results_path}/{filename}', 'r') as file:
...
def graph_fitness(results_path, filename='fitness.txt'):
    ...
    try:
        ...
        plt.savefig('./Neural_Network/'+results_path+'/fitness.jpeg', dpi=300, bbox_inches='tight')
    except Exception as e:
...
def graph_crash(results_path, track, filename='deaths.txt'):
    ...
    try:
        ...
        plt.savefig(f'./Neural_Network/{results_path}/crash_positions.jpeg', dpi=300, bbox_inches='tight')
    except Exception as e:
...
def graphs_acc_speed_time(results_path, data, max_t):
    ...
    for gen in data:
        ...
        fig1.savefig(f'./Neural_Network/{results_path}/acc_gen{gen}.jpeg', dpi=300, bbox_inches='tight')
        plt.close(fig1)
        ...
        fig2.savefig(f'./Neural_Network/{results_path}/steering_gen{gen}.jpeg', dpi=300, bbox_inches='tight')
        plt.close(fig2)
        ...
        ax3.set_ylim(0,101)
        fig3.savefig(f'./Neural_Network/{results_path}/speed_gen{gen}.jpeg', dpi=300, bbox_inches='tight')
        plt.close(fig3)
#----------------------------------------------------------------#
...
def graphs_acc_speed_track(results_path, data, track):
    ...
    for gen in data:
        ...
        plt.savefig(f'./Neural_Network/{results_path}/track_acc_gen{gen}.jpeg', dpi=300, bbox_inches='tight')
        plt.close()
        #--------------------------------------#
        ...
        plt.savefig(f'./Neural_Network/{results_path}/track_speed_gen{gen}.jpeg', dpi=300, bbox_inches='tight')
        plt.close()
...
def gifs_acc_speed(results_path, data, track):
    ...
    '''
    output_folder = f"./Neural_Network/{results_path}/frames"
    ...
    for gen in data:
        ...
        acc_gif_path = f"./Neural_Network/{results_path}/trajectory_acceleration_gen{gen}.gif"
        speed_gif_path = f"./Neural_Network/{results_path}/trajectory_speed_gen{gen}.gif"
