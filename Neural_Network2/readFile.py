...
def main(track_number):
    ...
    #          Fitness Plot          #
    #--------------------------------#
    with open("./Neural_Network2/"+txt_path+"/fitness.txt", "r") as file:
    ...
    #----------------------------------------------#
    with open("./Neural_Network2/"+txt_path+"/deaths.txt", "r") as file:
        linhas = file.readlines()
    for linha in linhas[1:]:
        partes = linha.split()
    ...
    plt.savefig("./Neural_Network2/"+txt_path+"/crash_positions.jpeg", dpi=300, bbox_inches='tight')


    try:
        inf = {}
        max_t = 0
        with open(f"./Neural_Network2/{txt_path}/best_behaviour.txt", "r") as file2:
        ...
        output_folder = f"./Neural_Network2/{txt_path}/frames"
        ...
        # Criação dos GIFs
        acc_gif_path = f"./Neural_Network2/{txt_path}/trajectory_acceleration.gif"
        speed_gif_path = f"./Neural_Network2/{txt_path}/trajectory_speed.gif"
    ...
    try:
        ...
        inf = {}
        max_t = 0
        with open("./Neural_Network2/"+txt_path+"/save_behaviour.txt", "r") as file:
            linhas = file.readlines()
    ...
    fig1.savefig("./Neural_Network2/"+txt_path+"/acc.jpeg", dpi=300, bbox_inches='tight')
    fig2.savefig("./Neural_Network2/"+txt_path+"/steering.jpeg", dpi=300, bbox_inches='tight')
    fig3.savefig("./Neural_Network2/"+txt_path+"/speed.jpeg", dpi=300, bbox_inches='tight')
